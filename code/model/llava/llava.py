...
""" PyTorch Llava model."""
import os
from transformers import CLIPVisionModel, CLIPImageProcessor, CLIPVisionConfig, LlamaConfig
...
class Llava1p5(LlavaPreTrainedModel):
    def __init__(self, config: LlavaConfig, kwargs=None):
    ...
    def forward(
        ...
        if not self.infer:
            loss = self.compute_loss(pooled_logits,batch_size//2)
        else:
            loss = None
    ...
    def compute_loss(self,pooled_logits,pair_num):
